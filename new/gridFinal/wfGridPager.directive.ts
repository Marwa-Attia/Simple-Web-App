...
import {Page,PagingOtions} from './WFGridUtil';
@Component({
    selector: 'wf-grid-paging',
    template:   '<div class="pagination-top-container">' +
                    '<div class="pagination-display">Displaying <strong class="ng-binding">{{wfGrid.pager.pageStart}} to {{wfGrid.pager.pageEnd}} of {{wfGrid.pager.totalRecords}}</strong></div>' +
                    '<div class="pagination-small pagination">'+
                        ...
                        '<div class="go-to-page">'+
                            ...
                            '<input type="text" class="form-control page-input" [(ngModel)]="wfGrid.pager.gotoPage" (change)="selectPage(gotoPage)">'+
                        '</div>' +
                    '</div>' +
                '</div>'
